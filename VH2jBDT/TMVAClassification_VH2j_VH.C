...
//#include  "/afs/cern.ch/user/g/gcamacho/CMSSW_9_4_9/src/PlotsConfigurations/Configurations/WW/Full2017/VH2jBDT/TMVAReader_Top.C+"
//#include  "TMVAReader_Top.C"
...
void TMVAClassification_VH2j_VH(TString myMethodList = "") 
{
  ...
  mycuts = "PuppiMET_pt > 20 \
            ...
            && abs(Lepton_eta[0] - Lepton_eta[1]) < 1.4 \
