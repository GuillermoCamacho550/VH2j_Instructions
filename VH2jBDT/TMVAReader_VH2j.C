...
void init_TMVAReader_VH2j(TTree* tree)
{
  ...
  tree->SetBranchAddress("Jet_qgl",      &loc0_Jet_qgl);
  ...
  myreader->AddVariable("Jet_qgl[CleanJet_jetIdx[0]]",       &loc_Jet_qgl0);
  myreader->AddVariable("Jet_qgl[CleanJet_jetIdx[1]]",       &loc_Jet_qgl1);
  myreader->AddVariable("pTWW",         &loc_pTWW);
  myreader->AddVariable("ptjj(CleanJet_pt[0], CleanJet_eta[0], CleanJet_phi[0], CleanJet_pt[1], CleanJet_eta[1], CleanJet_phi[1])",       &loc_ptjj);

  myreader->BookMVA("BDT", "/afs/cern.ch/user/g/gcamacho/CMSSW_9_4_9/src/PlotsConfigurations/Configurations/WW/Full2017/VH2jBDT/dataset/weights/TMVAClassification_VH2j_BDT.weights.xml");
}
...
float TMVAReader_VH2j(int entry)
{
  ...
  loc_Jet_qgl0   = loc0_Jet_qgl[0];
  loc_Jet_qgl1   = loc0_Jet_qgl[1];
  loc_pTWW       = loc0_pTWW;
  loc_ptjj       = ptjj(loc0_CleanJet_pt[0], loc0_CleanJet_eta[0], loc0_CleanJet_phi[0],loc0_CleanJet_pt[1], loc0_CleanJet_eta[1], loc0_CleanJet_phi[1]);
