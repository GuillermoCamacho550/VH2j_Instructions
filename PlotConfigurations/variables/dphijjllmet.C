...
float dphijjllmet(float jetpt1, float jeteta1, float jetphi1,
	          float jetpt2, float jeteta2, float jetphi2,
                  float leptonpt1=3., float leptoneta1=-1.2, float leptonphi1=2.1,
                  float leptonpt2=45., float leptoneta2=1.4, float leptonphi2=1.9,
		  float metpt=21., float metphi=2.3
		  )         
{
  TLorentzVector jet1;
  ...
  return fabs((jet1+jet2).DeltaPhi(lepton1+lepton2+met));
}
