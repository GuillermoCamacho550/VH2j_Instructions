...
float dphijjllmet(float jet1_pt, float jet1_eta, float jet1_phi,
...
float hww_dphijjllmet(int entry)
{
  TTreeReader fReader;
  ...
  return dphijjllmet(CleanJet_pt[0], CleanJet_eta[0], CleanJet_phi[0],
